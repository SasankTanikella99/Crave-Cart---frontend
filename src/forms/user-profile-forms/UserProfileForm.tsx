...
const UserProfileForm = ({onSave, isLoading, currentUser,   title = "User Profile",
  ...
  return (
    <Form {...form}>
        <form onSubmit={form.handleSubmit(onSave)} className="space-y-4 bg-gray-50 rounded-lg md:p-10">
            ...
            {isLoading ? <LoadingButton /> : <Button type="submit" className="bg-orange-600"> {buttonText} </Button>}
        </form> 
    </Form>
  )
}
